...
//	}
	...
	public void imageWrapFunctionTests() {
		...
		ExpressionTreeNode e = parser.makeExpression("imagewrap(\"AmoebaMorris.png\", x + x, y)");
		assertEquals(new Imagewrap("/images/AmoebaMorris.png", new Addition(new X(), new X()), new Y()), e);
	}
